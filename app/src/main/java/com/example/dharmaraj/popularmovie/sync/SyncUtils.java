...
/**
 * Created by Dharmaraj on 13-06-2017.
 */
...
public class SyncUtils {
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context) {
        ...
        Job movieJob = dispatcher.newJobBuilder()
    ...
    synchronized public static void initialize(@NonNull final Context context) {
        ...
        /*
         * This method call triggers App to create its task to synchronize  data
         * periodically.
         */
        ...
        Thread checkForEmpty = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Uri uri = MoviesContract.PopularMoviesEntry.CONTENT_URI;
                 ...
                 */
                String[] projectionColumns = {MoviesContract.PopularMoviesEntry.COLUMN_MOVIE_ID};
    ...
    public static void startImmediateSync(@NonNull final Context context) {
        Intent intentToSyncImmediately = new Intent(context, MoviesIntentService.class);
